...
public interface IPortalProgressCallback extends android.os.IInterface
{
  ...
  public static class Default implements com.google.android.setupcompat.portal.IPortalProgressCallback
  {
    /**
    ...
    /**
       ...
       */
    @Override public android.os.Bundle setPendingReason(int reasonResId, int quantity, int[] formatArgs, int reason) throws android.os.RemoteException
    {
      return null;
    }
    /**
       ...
       * @param formatArgs The format arguments that will be used for substitution.
       */
    @Override public android.os.Bundle setComplete(int resId, int quantity, int[] formatArgs) throws android.os.RemoteException
    {
      return null;
    }
    /**
       ...
       * @param formatArgs The format arguments that will be used for substitution.
       */
    @Override public android.os.Bundle setFailure(int resId, int quantity, int[] formatArgs) throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements com.google.android.setupcompat.portal.IPortalProgressCallback
  {
    private static final java.lang.String DESCRIPTOR = "com.google.android.setupcompat.portal.IPortalProgressCallback";
    ...
    /**
     * Cast an IBinder object into an com.google.android.setupcompat.portal.IPortalProgressCallback interface,
     * generating a proxy if needed.
     */
    public static com.google.android.setupcompat.portal.IPortalProgressCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.google.android.setupcompat.portal.IPortalProgressCallback))) {
        return ((com.google.android.setupcompat.portal.IPortalProgressCallback)iin);
      }
      return new com.google.android.setupcompat.portal.IPortalProgressCallback.Stub.Proxy(obj);
    }
    ...
    private static class Proxy implements com.google.android.setupcompat.portal.IPortalProgressCallback
    {
      ...
      @Override public android.os.Bundle setPendingReason(int reasonResId, int quantity, int[] formatArgs, int reason) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().setPendingReason(reasonResId, quantity, formatArgs, reason);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
      ...
      @Override public android.os.Bundle setComplete(int resId, int quantity, int[] formatArgs) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().setComplete(resId, quantity, formatArgs);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
      ...
      @Override public android.os.Bundle setFailure(int resId, int quantity, int[] formatArgs) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().setFailure(resId, quantity, formatArgs);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
      ...
      public static com.google.android.setupcompat.portal.IPortalProgressCallback sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(com.google.android.setupcompat.portal.IPortalProgressCallback impl) {
    ...
    public static com.google.android.setupcompat.portal.IPortalProgressCallback getDefaultImpl() {
  ...
  /**
     ...
     * @param formatArgs The format arguments that will be used for substitution.
     */
  public android.os.Bundle setPendingReason(int reasonResId, int quantity, int[] formatArgs, int reason) throws android.os.RemoteException;
  /**
     * Once the progress completed, and service can be destroy. Call this function.
     * SUW will unbind the service.
     * @param resId The resource identifier.
     ...
     * @param formatArgs The format arguments that will be used for substitution.
     */
  public android.os.Bundle setComplete(int resId, int quantity, int[] formatArgs) throws android.os.RemoteException;
  /**
     * Once the progress failed, and not able to finish the progress. Should call
     * this function. SUW will unbind service after receive setFailure. Client can
     * registerProgressService again once the service is ready to execute.
     ...
     * @param formatArgs The format arguments that will be used for substitution.
     */
  public android.os.Bundle setFailure(int resId, int quantity, int[] formatArgs) throws android.os.RemoteException;
}
